#!/usr/local/bin/php
<?php
// This script creates thumnails of file pictures by resizing them to 200px wide or 200px high, depending on the 
// longest side of the original file
//
// It takes as input a file named list that contains a list of files to process
// output is the thumbnail files with the name appended _th at the end
...
foreach( $all_lines as $value )
	...
	$thumbnail = strip_ext($thumbnail) . "_th.jpg";
...
if ((!isset($_GET['code']) || trim($_GET['code']) == ''))
	...
	if ($b == '')
		...
		$my_thumb_to_db = $my_thumb . "_th.jpg";
		$my_filename_to_db = $subject;
		$my_thumb = "../pictures/thumbnails/" . $my_thumb . "_th.jpg";
